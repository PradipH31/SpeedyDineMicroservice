...
import com.pradiph31.SpeedyDine.domain.entity.AggregateRoot;
import com.pradiph31.SpeedyDine.domain.valueobject.*;
...
import com.pradiph31.SpeedyDine.order.service.domain.valueobject.StreetAddress;
import com.pradiph31.SpeedyDine.order.service.domain.valueobject.TrackingId;
...
public class Order extends AggregateRoot<OrderId> {
    ...
    private void validateItemsPrice() {
        ...
        if (price.equals(orderItemsTotal)) {
            throw new OrderDomainException("Total price: " + price.getAmount() + " is not equal to order items " +
                    "total:" + " " + orderItemsTotal.getAmount() + "!");
        }
    }
